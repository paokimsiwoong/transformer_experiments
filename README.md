...
##### 1-2-4-2. 한쪽 언어 문장의 길이가 다른쪽 언어 문장의 길이보다 이상하게 긴 경우 확인

> TODO: 사전식 과번역, 한쪽 언어에 없는 맥락 추가, 대본 지시, 누락, 이상치 예시 이미지 추가

##### 1-2-4-3. 길이가 매우 긴 문장 확인

> TODO: 필터링 전/후 통계 표 추가
...
- 1M 데이터셋 실험(시드 고정)에서 test split으로 사용된 `(kor, en)` 쌍을 수집
