...
class LabelSmoothing(nn.Module):
    ...
    def forward(self, x, target):
        ...
        # print(f"==>> true_dist after fill_: {true_dist}")
        ...
        # self.confidence 입력
        # print(f"==>> true_dist after scatter_: {true_dist}")

        # pad 자리는 확률 값 0으로 변경
        true_dist[:, self.padding_idx] = 0
        # print(f"==>> true_dist after setting pad prob to 0: {true_dist}")
        ...
        # print(f"==>> true_dist after masked_fill_: {true_dist}")
        ...
        # print(torch.isnan(x.log()).any())
        # print(torch.isinf(x.log()).any())
